...
public class ResCloudlet {
	...
	public boolean setCloudletStatus(int status) {
		...
		int prevStatus = cloudlet.getStatus();// updated @cypherskar
	...
	public void finalizeCloudlet() {
		...
		if (cloudlet.getStatus()==Cloudlet.SUCCESS) // updated @cypherskar
		{ 
	...
	public int getCloudletStatus() {
		return cloudlet.getStatus(); // updated @cypherskar
	}
